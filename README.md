...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Language-C_&_Shell-007ACC?style=flat-square&logo=c&logoColor=white" alt="C Language" />
...
| Rank | Project | Focus | Score |
| :--- | :--- | :--- | :---: |
| 00 | **Shell 00** | Filesystem, Permissions, Groups | **85%** |
| 01 | **Shell 01** | Shell Scripting, Env Variables | **100%** |

### 🛠 C Programming

| Rank | Project | Key Concepts | Score |
| :--- | :--- | :--- | :---: |
| 00 | **C 00** | Basics, `write`, Alphabet, Loops | **85%** |
| 01 | **C 01** | Pointers, Arithmetic, Swap | **70%** |
| 02 | **C 02** | Strings, Arrays, Iteration | **65%** |
| 03 | **C 03** | String Manipulation (`str*` functions) | **75%** |
| 04 | **C 04** | Parsing, `argc`, `argv` | **70%** |
| 05 | **C 05** | Math, Roots, Recursion | **80%** |
